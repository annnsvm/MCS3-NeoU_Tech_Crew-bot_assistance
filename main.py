...
command_completer = NestedCompleter.from_nested_dict({
    ...
    "exit": None,
    "all-contacts": None,
    "add-contact": {"<name> <phone>:1234567890": None},
    "delete-contact": {"<name>": None},
    "show-phone": {"<name>": None},
    "change-phone": {"<name> <old phone>:1234567890 <new phone>:0987654321": None},
    "add-email": {"<name> <email>:email@gmail.com": None},
    "show-email": {"<name>": None},
    "add-address": {"<name> <city>:Kyiv <street>:Khreshchatyk <house number>:1": None},
    "show-address": {"<name>": None},
    "add-birthday": {"<name> <birthday>:01.01.2000": None},
